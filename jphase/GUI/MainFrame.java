...
public class MainFrame extends JFrame {
	...
	private JMenuItem eq;
	
	private JMenuItem sum1;
	
	private JMenuItem min1;
	
	private JMenuItem max1;
	
	private JMenuItem wq;
	
	private JMenuItem times;
	
	private JMenuItem mix1;

	private JMenuItem rtime;
	/**
	 * Help Menu
	 */
	...
	public MainFrame(){
		...
		OperationsMenu.setMnemonic(KeyEvent.VK_J);
		menuBar.add(OperationsMenu);  
		
		max1 = new JMenuItem("Max");
		max1.addActionListener(	
				new MainFrame_Operationmax1_actionAdapter(this));
		OperationsMenu.add(max1);
		
		mix1 = new JMenuItem("Mix");
		mix1.addActionListener(
				new MainFrame_Operationmix1_actionAdapter(this));
		OperationsMenu.add(mix1);
		
		
		min1 = new JMenuItem("Min");
		min1.addActionListener(
				new MainFrame_Operationmin1_actionAdapter(this));
		OperationsMenu.add(min1);
		

		eq = new JMenuItem("eqResidualTime");
		eq.addActionListener(
				new MainFrame_Operationeq_actionAdapter(this));
		OperationsMenu.add(eq);
		
		wq = new JMenuItem("WaitingQ");
		wq.addActionListener(
				new MainFrame_Operationwq_actionAdapter(this));
		OperationsMenu.add(wq);
		
		times = new JMenuItem("Times");
		times.addActionListener(
			new MainFrame_Operationtimes_actionAdapter(this));
		OperationsMenu.add(times);
		
		sum1 = new JMenuItem("Sum");
		sum1.addActionListener(
			new MainFrame_Operationsum1_actionAdapter(this));
		OperationsMenu.add(sum1);
		
		rtime = new JMenuItem("Residual Time");
		rtime.addActionListener(
				new MainFrame_Operationrtime_actionAdapter(this));
		OperationsMenu.add(rtime);
		/**
		 * Operations Menu plus Buttons for Max Mix Min Sum
		 * MACC 2017
		 */
	...
	public TreeManagerPanel  getTreeConstentPane() {
		return this.treeContentPane;
	}
		  ...
		  if(treeContentPane==null){
			  JOptionPane.showMessageDialog(null,  
			   ...
			   if(!res){log.append("New variable cannot be created " +
				   ...
				   NewVarFrame myFrame = new NewVarFrame();														//importane 
				   myFrame.setVisible(true);
				   treeContentPane.addVar(myFrame.varName, myFrame.var);
				   this.pack();																				// para lo que retorne phases
			   }
		  }
	  }
	...
	public ArrayList<PhaseVarInfo> getVariables() {
	 ...
	 class MainFrame_Operationmax1_actionAdapter
	    implements java.awt.event.ActionListener {
		 ...
		 * 
		 */
		MainFrame_Operationmax1_actionAdapter(MainFrame adaptee) {
			this.adaptee = adaptee;
		}

		public void actionPerformed(ActionEvent e) {
			adaptee.Operationmax1_actionPerformed(e);
			
			}
		}

		public void Operationmax1_actionPerformed(ActionEvent e) {
			  MaxC q = new MaxC(this);
				q.setVisible(true);
			
			}
		 class MainFrame_Operationmix1_actionAdapter
		    implements java.awt.event.ActionListener {
			 ...
			 * 
			 */
			MainFrame_Operationmix1_actionAdapter(MainFrame adaptee) {
				this.adaptee = adaptee;
			}

			public void actionPerformed(ActionEvent e) {
				adaptee.Operationmix1_actionPerformed(e);
				
				}
			}

			public void Operationmix1_actionPerformed(ActionEvent e) {
				MixC w = new MixC(this);
				w.setVisible(true);
				
				}
	class MainFrame_Operationsum1_actionAdapter
			    implements java.awt.event.ActionListener {
				 ...
				 * 
				 */
				MainFrame_Operationsum1_actionAdapter(MainFrame adaptee) {
					this.adaptee = adaptee;
				}

				public void actionPerformed(ActionEvent e) {
					adaptee.Operationsum1_actionPerformed(e);
					
					}
				}

				public void Operationsum1_actionPerformed(ActionEvent e) {
					SumC r = new SumC(this);
					r.setVisible(true);
					
					}
	
	class MainFrame_Operationmin1_actionAdapter
    implements java.awt.event.ActionListener {
	 ...
	 * 
	 */
	MainFrame_Operationmin1_actionAdapter(MainFrame adaptee) {
		this.adaptee = adaptee;
	}

	public void actionPerformed(ActionEvent e) {
		adaptee.Operationmin1_actionPerformed(e);
		
		}
	}

	public void Operationmin1_actionPerformed(ActionEvent e) {
		MinC y = new MinC(this);
		y.setVisible(true);
		//treeContentPane.addVar(y.varName1, y.res);
		//this.pack();		
	...
	class MainFrame_Operationeq_actionAdapter
    implements java.awt.event.ActionListener {
	 ...
	 * 
	 */
	MainFrame_Operationeq_actionAdapter(MainFrame adaptee) {
		this.adaptee = adaptee;
	}

	public void actionPerformed(ActionEvent e) {
		adaptee.Operationeq_actionPerformed(e);
		
		}
	}

	public void Operationeq_actionPerformed(ActionEvent e) {
		eqResidualTimec t = new eqResidualTimec(this);
		t.setVisible(true);
		//treeContentPane.addVar(y.varName1, y.res);
		//this.pack();		
	...
	class MainFrame_Operationwq_actionAdapter
    implements java.awt.event.ActionListener {
	 ...
	 * 
	 */
	MainFrame_Operationwq_actionAdapter(MainFrame adaptee) {
		this.adaptee = adaptee;
	}

	public void actionPerformed(ActionEvent e) {
		adaptee.Operationwq_actionPerformed(e);
		
		}
	}

	public void Operationwq_actionPerformed(ActionEvent e) {
		waitingQ u = new waitingQ(this);
		u.setVisible(true);
		//treeContentPane.addVar(y.varName1, y.res);
		//this.pack();		
		
		}
	class MainFrame_Operationtimes_actionAdapter
    implements java.awt.event.ActionListener {
	 ...
	 * 
	 */
	MainFrame_Operationtimes_actionAdapter(MainFrame adaptee) {
		this.adaptee = adaptee;
	}

	public void actionPerformed(ActionEvent e) {
		adaptee.Operationtimes_actionPerformed(e);
		
		}
	}

	public void Operationtimes_actionPerformed(ActionEvent e) {
		Times b = new Times(this);
		b.setVisible(true);
		//treeContentPane.addVar(b.varName1, b.res);
		//this.pack();		
	}
	class MainFrame_Operationrtime_actionAdapter
    implements java.awt.event.ActionListener {
	 ...
	 * 
	 */
	MainFrame_Operationrtime_actionAdapter(MainFrame adaptee) {
		this.adaptee = adaptee;
	}

	public void actionPerformed(ActionEvent e) {
		adaptee.Operationrtime_actionPerformed(e);
		
		}
	}

	public void Operationrtime_actionPerformed(ActionEvent e) {
		ResidualTime b = new ResidualTime(this);
		b.setVisible(true);
		//treeContentPane.addVar(b.varName1, b.res);
		//this.pack();		
	}
