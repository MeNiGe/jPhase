...
public class MaxC extends JDialog implements  ItemListener, ActionListener{
	public final String ACEPT = "Get Max";	
	...
	MainFrame window;
	public MaxC(MainFrame window){
		this.window = window;
		setTitle("JPhase - Max Generator");
		...
		JLabel label2 = new JLabel("In order to get Max Values");
