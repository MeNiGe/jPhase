...
public class MinC extends JDialog implements  ItemListener, ActionListener{
	public final String ACEPT = "Get Min";	
	...
	MainFrame window;
	public MinC(MainFrame window){
		this.window = window;
		setTitle("JPhase - Min Generator");
