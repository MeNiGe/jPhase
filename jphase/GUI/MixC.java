...
public class MixC extends JDialog implements  ItemListener, ActionListener{
	public final String ACEPT = "Mix!";	
	...
	MainFrame window;
	public MixC(MainFrame window){
		this.window = window;
		setTitle("JPhase - Mix Generator");
		...
		JLabel label2 = new JLabel("In order to Mix Values");
