...
public class SumC extends JDialog implements  ItemListener, ActionListener{
	public final String ACEPT = "Sum!";	
	...
	MainFrame window;
	public SumC(MainFrame window){
		this.window = window;
		setTitle("JPhase - Sum Generator");
		...
		JLabel label2 = new JLabel("In order to Sum Values");
