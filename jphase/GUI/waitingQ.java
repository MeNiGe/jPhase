...
public class waitingQ extends JDialog implements  ItemListener, ActionListener{
	public final String ACEPT = "Load";	
	...
	MainFrame window;
	public waitingQ(MainFrame window){
		this.window = window;
		setTitle("JPhase - Load Generator");
		...
		JLabel label2 = new JLabel("In order to get load Values");
		JLabel label3 = new JLabel("Load must be > 0 but < 1");
